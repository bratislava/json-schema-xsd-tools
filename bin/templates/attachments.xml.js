...
<attachment:attachments xmlns:manifest="urn:manifest:1.0"
  ...
  xmlns:data="urn:data:1.0" xmlns:attachment="urn:attachment:1.0">
  <attachment:entry media-type="text/xml" full-path="Attachments\posp.xml" description="posp"
    filename="posp.xml" />
