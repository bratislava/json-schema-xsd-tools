...
<xs:schema elementFormDefault="qualified" xmlns="http://schemas.gov.sk/form/{eformIdentifier}/{eformVersion}" xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="http://schemas.gov.sk/form/{eformIdentifier}/{eformVersion}">
